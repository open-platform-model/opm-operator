...
// owning catalog by (0010:D25). The stamp is unforgeable, so a
...
// That is the value 0015:D2's refusal has to name.
//
...
// entry of the platform it is judged against (0015:D13), so its
...
// very platform the next reconcile judges it against (0015:D13),
...
// accepted again — the oscillation 0015:D13's loop has to avoid. A claim's own
