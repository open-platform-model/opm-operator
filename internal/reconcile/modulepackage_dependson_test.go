...
func readyModulePackageFixture(name string, ready bool) *releasesv1alpha1.ModulePackage {
...
func TestCheckDependsOn(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			objects: []runtime.Object{
				readyModulePackageFixture("dep-a", true),
				readyModulePackageFixture("dep-b", false),
			},
			wantBlocker: "dep-b",
		},
		{
			...
			objects: []runtime.Object{&releasesv1alpha1.ModulePackage{
		...
		},
		{
			...
			objects:   []runtime.Object{readyModulePackageFixture("dep-a", true)},
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			rel := &releasesv1alpha1.ModulePackage{
				...
				Spec:       releasesv1alpha1.ModulePackageSpec{DependsOn: tt.dependsOn},
			}
