...
- [x] 3.5 `docker/build-push-action` with `platforms: linux/amd64,linux/arm64,linux/s390x,linux/ppc64le`, GHA cache, `push: true`; capture `steps.build.outputs.digest`.
