...
No behavior change. The ownership-guard requirement gains the CLI-manager-identity tolerance scenario (enhancement 0006 D40's post-handoff window), test-pinning what `core.IsOPMManagedBy` already accepts.
